Shader "UUIFX/RotateFlowingUV"
{
    Properties
    {
        ...
        _MainColor ("Main Color", Color) = (1, 1, 1, 1) // 添加 Flow Color 属性用于叠加 _FlowTexture 的颜色
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 _MainColor; // 添加 _FlowColor 属性
            ...
            {
                fixed4 baseColor = tex2D(_MainTex, input.uv) * _MainColor;
