Shader "UUIFX/SinRotateFlowingUV"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t input)
            {
                ...
                // 计算旋转后的UV坐标
                float2 rotatedUV;
                rotatedUV.x = offset.x * cos(rotationAngle) - offset.y * sin(rotationAngle) * sin(_Time.y);
                rotatedUV.y = offset.x * sin(rotationAngle) + offset.y * cos(rotationAngle) * sin(_Time.y);
